...
[format ["variable %1: %2", KEY_CLASS, _class], DEBUG_STR_PROFILES, DEBUG_CFG] call CBA_fnc_debug;

player setVariable [KEY_REPUTATION, _reputation];
[format ["variable %1: %2", KEY_REPUTATION, _reputation], DEBUG_STR_PROFILES, DEBUG_CFG] call CBA_fnc_debug;

player setVariable [KEY_MONEY, _money];
[format ["variable %1: %2", KEY_MONEY, _money], DEBUG_STR_PROFILES, DEBUG_CFG] call CBA_fnc_debug;

player setVariable [KEY_IS_RENEGADE, _renegade];
[format ["variable %1: %2", KEY_IS_RENEGADE, _renegade], DEBUG_STR_PROFILES, DEBUG_CFG] call CBA_fnc_debug;

player setVariable [KEY_PRISON_START, _prisonTime];
[format ["variable %1: %2", KEY_PRISON_START, _prisonTime], DEBUG_STR_PROFILES, DEBUG_CFG] call CBA_fnc_debug;

player setVariable [KEY_POSITION, _position];
[format ["variable %1: %2", KEY_POSITION, _position], DEBUG_STR_PROFILES, DEBUG_CFG] call CBA_fnc_debug;
