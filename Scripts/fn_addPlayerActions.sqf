...
private _registeredCondition = format ["!(_this getVariable ['%1', false])", KEY_REGISTERED];

player addAction ["Show reputation", { player call X11_fnc_showReputation; } , [], 0.5];
player addAction ["Show intel progress", { [player, clientOwner] remoteExec ["X11_fnc_showIntelProgress", 2]; } , [], 0.5, true, true, "", _registeredCondition];
