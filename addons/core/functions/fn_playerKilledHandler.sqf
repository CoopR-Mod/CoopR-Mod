...
if(player getVariable [COOPR_KEY_STATE, COOPR_STATE_OK] isEqualTo COOPR_STATE_OK) then {
    ...
    _baseLoadout = (player getVariable COOPR_KEY_ROLE) call coopr_fnc_getLoadoutForRole;
    ...
    [EXEC_SERVER, "coopr_fnc_updateCharacter", [getPlayerUID player, _state, _slot], //request-related
        [], {
        sleep 5;
