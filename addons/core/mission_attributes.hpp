...
#define COOPR_CALL_STACK (missionNamespace getVariable ["coopr_core_call_stack", false])
// rpg addon
...
#define COOPR_WIA_REDUCTION (missionNamespace getVariable ["coopr_rpg_wia_rep_reduction", 0.2])
// persistence addon
