...
if (isServer) then {
    ...
    private _characterId = [_reconEntry, COOPR_CHAR_RECON_ENTRY_OWNER] call CBA_fnc_hashGet;
    ...
    [_reconEntry, COOPR_CHAR_RECON_ENTRY_ID, _countEntries + 1] call CBA_fnc_hashSet;
