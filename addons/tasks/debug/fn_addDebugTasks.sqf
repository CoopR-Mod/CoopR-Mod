...
if (COOPR_DEV_MODE) then {
    ...
    [_newCooprTask, COOPR_KEY_TASK_UID, "76561197977776587"] call CBA_fnc_hashSet;
    ...
    [_newCooprTask, COOPR_KEY_TASK_TARGET, "FireTeam"] call CBA_fnc_hashSet;
    [_newCooprTask, COOPR_KEY_TASK_CREATED, 2993.16] call CBA_fnc_hashSet;
