class CoopR_ReconReport_Dialog
{
	...
	class ControlsBackground
	{
		...
		{
			type = 0;
			idc = GUI_ID_RECONREPORT_BACKGROUND;
	...
	class Controls
	{
		...
		{
			type = 2;
			idc = GUI_ID_RECONREPORT_MARKER_EDIT;
		...
		{
			type = 4;
			idc = GUI_ID_RECONREPORT_TYPE_COMBO;
		...
		{
			type = 4;
			idc = GUI_ID_RECONREPORT_STRENGTH_COMBO;
		...
		{
			type = 4;
			idc = GUI_ID_RECONREPORT_BEHAVIOUR_COMBO;
		...
		{
			type = 0;
			idc = GUI_ID_RECONREPORT_SENDER_LABEL;
		...
		{
			type = 16;
			idc = GUI_ID_RECONREPORT_WRITE_BUTTON;
		...
		{
			type = 16;
			idc = GUI_ID_RECONREPORT_REMOVE_BUTTON;
		...
		{
			type = 0;
			idc = GUI_ID_RECONREPORT_TIME_LABEL;
		...
		{
			type = 13;
			idc = GUI_ID_RECONREPORTS_ENTRIES_STRUCT;
			x = safeZoneX + safeZoneW * 0.384375;
		...
		{
			type = 4;
			idc = GUI_ID_RECONREPORT_ENTRYREMOVE_COMBO;
			x = safeZoneX + safeZoneW * 0.386875;
