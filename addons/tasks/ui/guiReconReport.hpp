class CoopR_ReconReport_Dialog
{
    ...
    class Controls
    {
        class CoopR_ReconReport_Type_Combobox
        {
            type = 4;
            idc = 11051;
            x = safeZoneX + safeZoneW * 0.47625;
        ...
        class CoopR_ReconReport_Strength_Combobox
        {
            type = 4;
            idc = 11052;
        ...
        class CoopR_ReconReport_Behaviour_Combobox
        {
            type = 4;
            idc = 11053;
        ...
        class CoopR_ReconReport_Additional_Edit
        {
            ...
            y = safeZoneY + safeZoneH * 0.31666667;
            w = safeZoneW * 0.1375;
            h = safeZoneH * 0.05222223;
            style = 0;
            text = "<enter additional information here>";
            autocomplete = "";
            colorBackground[] = {0.3804, 0.3961, 0.239, 1};
            colorDisabled[] = {0.2,0.2,0.2,1};
            colorSelection[] = {1,0,0,1};
            colorText[] = {0.302,0.1137,0.451,1};
            font = "PuristaMedium";
            sizeEx = (((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1);
        ...
        class CoopR_ReconReport_Write_Button
        {
            ...
            text = "create entry";
            borderSize = 0;
            colorBackground[] = {0.549,0.0706,0.149,1};
            colorBackgroundActive[] = {1,0,0,1};
            colorBackgroundDisabled[] = {0.2,0.2,0.2,1};
            colorBorder[] = {0,0,0,0};
            colorDisabled[] = {0.2,0.2,0.2,1};
            colorFocused[] = {0.2,0.2,0.2,1};
            colorText[] = {0.451,0.9294,0.851,1};
            colorShadow[] = {0, 0, 0, 0};
            font = "PuristaMedium";
            offsetPressedX = 0.01;
            offsetPressedY = 0.01;
