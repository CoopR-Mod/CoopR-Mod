class X11_NewProfile_Dialog{
    ...
    class Controls {
        ...
        class X11_NewProfile_Background: RscText
        {
            idc = 3000;
        ...
        class X11_NewProfile_Title: RscText
        {
            idc = 3001;
        ...
        class X11_NewProfile_Edit_Name: RscEdit
        {
            idc = 3400;
            x = 0.216462 * safezoneW + safezoneX;
        ...
        class X11_NewProfile_Label_Name: RscText
        {
            idc = 3002;
        ...
        class X11_NewProfile_Label_Specialisation: RscText
        {
            idc = 3003;
        ...
        class X11_NewProfile_Combo_Specialisation: RscCombo
        {
            idc = 3100;
            x = 0.216462 * safezoneW + safezoneX;
        ...
        class X11_NewProfile_ClassPicture: RscPicture
        {
            idc = 3200;
